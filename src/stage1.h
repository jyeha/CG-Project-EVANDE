...
static const char* track_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_track.obj";
static const char* start_floor_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_start_floor_obejcts.obj";
static const char* end_floor_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_end_floor_obejcts.obj";
static const char* start_wall_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_start_wall.obj";
static const char* end_wall_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_end_wall.obj";
static const char* start_trigger_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_start_trigger.obj";
static const char* end_trigger_mesh_obj = "../bin/mesh/Stages/stage1/tracks/stage1_end_trigger.obj";
static const char* background_mesh_obj = "../bin/mesh/Stages/stage1/tracks/background.obj";
...
private:
	...
	void create_items_list() {
		items_list.push_back("../bin/mesh/Stages/stage1/items/aplus1.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/aplus2.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/aplus3.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/aplus4.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/aplus5.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin1.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin2.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin3.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin4.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin5.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin6.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin7.obj");
		items_list.push_back("../bin/mesh/Stages/stage1/items/coin8.obj");
	}

	void create_obstacles_list() {
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus4.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus5.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus6.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus7.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus8.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/bus9.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/carpet1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/carpet2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/carpet3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju4.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju5.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju6.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju7.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage1/obstacle/soju8.obj");
	}

	void create_sound_source() {
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/we_are_the_champion.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/skku.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/military.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/ib_memory.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/Time_To_Say_Goodbye.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/ending.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/yay.mp3"));
		bgm_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/game_over.mp3"));

		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/bus.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/booster.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/water.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/coin.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/swallow.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/back.mp3"));
		sounds_list.push_back(engine->addSoundSourceFromFile("../bin/sounds/nope.mp3"));

		sounds_list[5]->setDefaultVolume(0.5f);
	}
...
public:
	...
	bool init(GLuint _program, GLFWwindow* _window, camera& cam) {
		...
		mesh2* sphere_mesh = make_sphere();
		mesh2* track_mesh = make_object_from_file(track_mesh_obj);
		mesh2* start_floor_mesh = make_object_from_file(start_floor_mesh_obj);
		mesh2* end_floor_mesh = make_object_from_file(end_floor_mesh_obj);
		mesh2* start_wall_mesh = make_object_from_file(start_wall_mesh_obj);
		mesh2* end_wall_mesh = make_object_from_file(end_wall_mesh_obj);
		mesh2* background_mesh = make_object_from_file(background_mesh_obj);
		mesh2* start_trigger_mesh = make_object_from_file(start_trigger_mesh_obj);
		mesh2* end_trigger_mesh = make_object_from_file(end_trigger_mesh_obj);
