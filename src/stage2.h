...
static const char* track_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_track.obj";
static const char* start_floor_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_start_floor_obejcts.obj";
static const char* end_floor_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_end_floor_obejcts.obj";
static const char* start_wall_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_start_wall.obj";
static const char* end_wall_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_end_wall.obj";
static const char* start_trigger_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_start_trigger.obj";
static const char* end_trigger_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/stage2_end_trigger.obj";
static const char* background_mesh_obj2 = "../bin/mesh/Stages/stage2/tracks/background2.obj";

extern bool clear;
extern bool game_over;
extern irrklang::ISoundEngine* engine;
extern std::vector<irrklang::ISoundSource*> bgm_list;
extern std::vector<irrklang::ISoundSource*> sounds_list;
...
private:
	...
	void create_items_list() {
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus1.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus2.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus3.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus4.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus5.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus6.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus7.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus8.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus9.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus10.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/aplus11.obj");

		items_list.push_back("../bin/mesh/Stages/stage2/items/coin1.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin2.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin3.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin4.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin5.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin6.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin7.obj");
		items_list.push_back("../bin/mesh/Stages/stage2/items/coin8.obj");
	}

	void create_obstacles_list() {
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus4.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus5.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus6.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus7.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus8.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus9.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus10.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus11.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus12.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus13.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus14.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus15.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus16.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/bus17.obj");

		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet4.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet5.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet6.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet7.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet8.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet9.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet10.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet11.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet12.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet13.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet14.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet15.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/carpet16.obj");

		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju1.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju2.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju3.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju4.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju5.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju6.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju7.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju8.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju9.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju10.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju11.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju12.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju13.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju14.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju15.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju16.obj");
		obstacles_list.push_back("../bin/mesh/Stages/stage2/obstacle/soju17.obj");
	}
...
public:
	...
	bool init(GLuint _program, GLFWwindow* _window, camera& cam) {
		...
		mesh2* sphere_mesh = make_sphere();
		mesh2* track_mesh = make_object_from_file(track_mesh_obj2);
		mesh2* start_floor_mesh = make_object_from_file(start_floor_mesh_obj2);
		mesh2* end_floor_mesh = make_object_from_file(end_floor_mesh_obj2);
		mesh2* start_wall_mesh = make_object_from_file(start_wall_mesh_obj2);
		mesh2* end_wall_mesh = make_object_from_file(end_wall_mesh_obj2);
		mesh2* background_mesh = make_object_from_file(background_mesh_obj2);
		mesh2* start_trigger_mesh = make_object_from_file(start_trigger_mesh_obj2);
		mesh2* end_trigger_mesh = make_object_from_file(end_trigger_mesh_obj2);
